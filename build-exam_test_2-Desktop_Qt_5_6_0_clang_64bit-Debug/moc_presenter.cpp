...
#include "../exam_test_2/presenter.h"
...
QT_MOC_LITERAL(1, 10, 11), // "addQuestion"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 14) // "removeQuestion"

    },
    "Presenter\0addQuestion\0\0removeQuestion"
};
...
const QMetaObject Presenter::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Presenter.data,
      qt_meta_data_Presenter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Presenter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Presenter.stringdata0))
        return static_cast<void*>(const_cast< Presenter*>(this));
